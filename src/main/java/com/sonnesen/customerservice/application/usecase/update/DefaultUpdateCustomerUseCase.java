...
public class DefaultUpdateCustomerUseCase implements UpdateCustomerUseCase {

    private final CustomerRepositoryPort customerRepository;

    public DefaultUpdateCustomerUseCase(final CustomerRepositoryPort customerRepository) {
    ...
    public void execute(final UpdateCustomerCommand command) {
        ...
        final var customer = customerRepository.findById(command.customerId()).orElseThrow(
